...
import Aulads from "../../assets/aulas.png"
...
//[{}, {}, {}] array de objetos
   ...
   return (
    ...
    <div className={styles.BoxTitulosAcoes}>
      ...
      <p>Junte-se a quem acredita na mudança. Apoie, participe e transforme vidas através de ações sociais que geram impacto nas comunidades.</p>
    </div>
